...
static constexpr auto qt_meta_stringdata_ZN9newwindowE = QtMocHelpers::stringData(
    "newwindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9newwindowE[] = {
...
Q_CONSTINIT const QMetaObject newwindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9newwindowE.offsetsAndSizes,
    qt_meta_data_ZN9newwindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9newwindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *newwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9newwindowE.stringdata0))
